...
// 	if method == "POST" && path == "/" {
// 		SimpleWriteHandler(repo, config.AccrualURL, "1")(w, request)
// 	}

// 	if method == "POST" && path == "/api/shorten" {
// 		SimpleJSONHandler(repo, config.AccrualURL, "1")(w, request)
// 	}
...
// 	if method == "DELETE" {
// 		DeleteItemsHandler(repo, wp, config.AccrualURL, "1")(w, request)
// 	}
...
// 	assert.Equal(t, config.AccrualURL+"/1", body1)
...
// 	newResult := repository.Result{ShortURL: config.AccrualURL + "/2"}
...
// 	var links []string
// 	links = append(links, config.AccrualURL + "/1")
// 	links = append(links, config.AccrualURL + "/2")
